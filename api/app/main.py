...
_PREDICT_ENDPOINT_METADATA: dict[str, Any] = {
...
app = FastAPI(**_APP_METADATA)

_PlayerStatsField = Annotated[
    Player,
    Body(
...
@app.post('/predict/', **_PREDICT_ENDPOINT_METADATA)
def predict(player_stats: _PlayerStatsField, year: _YearField) -> PredictionResponse:
